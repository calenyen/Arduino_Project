...
#include <AnalogSmooth.h>
  #define moveNum 20
AnalogSmooth asA0 = AnalogSmooth(moveNum);
AnalogSmooth asA1 = AnalogSmooth(moveNum);
AnalogSmooth asA2 = AnalogSmooth(moveNum);
AnalogSmooth asA3 = AnalogSmooth(moveNum);
AnalogSmooth asA01 = AnalogSmooth(moveNum);
AnalogSmooth asA23 = AnalogSmooth(moveNum);
...
/*
  ...
  */
  ...
  float analogA0 = static_cast<float>(AIvalue0);  //unsigned int to float
  float analogA1 = static_cast<float>(AIvalue1);
  float analogA2 = static_cast<float>(AIvalue2);
  float analogA3 = static_cast<float>(AIvalue3);
  float analogA01 = static_cast<float>(AIvalue01);
  float analogA23 = static_cast<float>(AIvalue23);
